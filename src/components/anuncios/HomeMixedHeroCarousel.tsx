        ...
        {items.map((slide, slideIndex) => {
          ...
          return (
            ...
            >
              ...
              <img src={slideImage} alt={slideTitle} decoding="async" loading={slideIndex === 0 ? "eager" : "lazy"} className="absolute inset-x-0 top-0 h-[calc(100%-7rem)] w-full object-cover object-center sm:h-[calc(100%-7.5rem)]" />
              <div className="absolute inset-0 bg-gradient-to-t from-background from-[7rem] via-background/60 via-[calc(7rem+1.5rem)] to-transparent to-[calc(7rem+3.5rem)]" />
              {slide.date && (
              ...
              <div className="absolute inset-x-0 bottom-0 mx-auto w-full max-w-6xl px-4 flex h-[7rem] flex-col justify-end pb-5 text-center sm:h-[7.5rem] text-foreground sm:px-8 sm:pb-9">
